<template>
    ...
    <Row>
        ...
        <xian_suo_menu 
            ...
            @start_action_emit="start_action"
            @start_init_emit="start_init">
        </xian_suo_menu>
...
import xian_suo_menu from "@/components/tree/xian_suo_menu.vue";
...
import {
    ...
    insert_js,
    start_init_js
} from "@/assets/js/tree/ThrdBTree.js";
