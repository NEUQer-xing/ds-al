<template>
    <Row>
        ...
        <Col span="7">
        <introduce> 堆 排 序</introduce>
        <control @control_speed="speed_func" @control_scale="scale_func" @control_scale_reset="scale_reset"></control>
        <heap_sort_menu @show_style_emit="show_style" @creat_random_array_emit="creat_random_array"
...
import heap_sort_menu from "@/components/sort/heap_sort_menu.vue";
...
import {
    ...
    start_sort_js,
} from "@/assets/js/sort/HeapSort.js";
