<template>
  <Row>
    ...
    <linkedqueue_menu @list_insert="insert" @list_delete="Delete"></linkedqueue_menu>
...
import linkedqueue_menu from "@/components/list/linkedqueue_menu.vue";
...
import {
  ...
  list_insert_index,
  list_delete_index,
} from "@/assets/js/list/LinkedQueue.js";
