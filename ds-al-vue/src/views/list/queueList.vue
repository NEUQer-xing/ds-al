<template>
  <Row>
    ...
    <Col span="7">
    <introduce>队列</introduce>
    <control @control_speed="speed_func" @control_scale="scale_func" @control_scale_reset="scale_reset"></control>
    <queue_menu @list_init="init_list" @list_insert="insert" @list_delete="Delete"></queue_menu>
...
import queue_menu from "@/components/list/queue_menu.vue";
...
function insert(insert_value) {
  list_insert_index(insert_value.value);
}
